...
PURPOSE:
  1) Demonstrate how to scrape nanny (childcare) data from Care.com, respecting a 500-record
...
sys.path.append('..')
from Scrapers.care_com.USA.childcare_helpers_attribute_combo import (
...
class AllChildCareNanny:
    """
    A pipeline to scrape nanny (childcare) data from Care.com using a
...
"""
    ...
    def _make_payload(self, search_after: str, pay_min: int, pay_max: int) -> dict:
        ...
        return {
            ...
            "variables": {
                "input": {
                    "careType": "NANNY",  # specifically nanny
                    "filters": {
                        "payRange": {
                            "min": {
                                "amount": pay_min,
    ...
    def _get_total_hits_for_range(self, pay_min: int, pay_max: int) -> int:
        ...
        try:
            ...
            time.sleep(round(random.uniform(0.65, 0.9), 4))
    ...
    def run(self):
        ...
        try:
            ...
            while ranges_to_check:
                ...
                if first_total_hits == 0: first_total_hits = total_hits
                ...
                if total_hits > 500:
                    if pay_min == pay_max:
                        ...
                        base_attrs = [
                            ...
                            "NON_SMOKER",
                            "OWN_TRANSPORTATION",
                            "EXPERIENCE_WITH_SPECIAL_NEEDS",
                            "CPR_TRAINED",
                            "FIRST_AID_TRAINED"
                        ]
                        wraper_provider_key = list(["searchProvidersChildCare"]) # eg: "searchProvidersChildCare"
