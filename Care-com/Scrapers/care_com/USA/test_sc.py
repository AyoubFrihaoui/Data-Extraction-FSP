...
PURPOSE:
  1) Demonstrate how to scrape in home (SeniorCare) data from Care.com, respecting a 500-record
...
class AllSeniorCareInHome:
    """
    A pipeline to scrape babysitting (seniorcare) data from Care.com using a
...
"""
    ...
    def __init__(
        ...
        :param care_type: e.g., "seniorcare"
        :param sub_type: e.g., "inhome"
    ...
    def _make_payload(self, search_after: str, pay_min: int, pay_max: int) -> dict:
        ...
        return {
            ...
            "variables": {
                "input": {
                    "careType": "COMPANION",  # specifically nanny
                    "filters": {
                        "payRange": {
                            "min": {
                                "amount": pay_min,
    ...
    def _get_total_hits_for_range(self, pay_min: int, pay_max: int) -> int:
        ...
        try:
            ...
            senior_care_data = data["data"]["searchProvidersSeniorCare"]
